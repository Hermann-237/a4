...
function SingleVerb() {
    ...
    function simo() {
        for (let i = 0; i < data1.length; i++) {
            if (data1[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data1[i].conjugated_forms[1][1] === verbSingleOne || data1[i].conjugated_forms[1][1] === verbSingleOne || data1[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data1[i]]
        }
        for (let i = 0; i < data2.length; i++) {
            if (data2[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data2[i].conjugated_forms[1][1] === verbSingleOne || data2[i].conjugated_forms[1][1] === verbSingleOne || data2[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data2[i]]
        }
        for (let i = 0; i < data3.length; i++) {
            if (data3[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data3[i].conjugated_forms[1][1] === verbSingleOne || data3[i].conjugated_forms[1][1] === verbSingleOne || data3[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data3[i]]
        }
        for (let i = 0; i < data4.length; i++) {
            if (data4[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data4[i].conjugated_forms[1][1] === verbSingleOne || data4[i].conjugated_forms[1][1] === verbSingleOne || data4[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data4[i]]
        }
        for (let i = 0; i < data5.length; i++) {
            if (data5[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data5[i].conjugated_forms[1][1] === verbSingleOne || data5[i].conjugated_forms[1][1] === verbSingleOne || data5[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data5[i]]
        }
        for (let i = 0; i < data6.length; i++) {
            if (data6[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data6[i].conjugated_forms[1][1] === verbSingleOne || data6[i].conjugated_forms[1][1] === verbSingleOne || data6[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data6[i]]
        }
        for (let i = 0; i < data7.length; i++) {
            if (data7[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data7[i].conjugated_forms[1][1] === verbSingleOne || data7[i].conjugated_forms[1][1] === verbSingleOne || data7[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data7[i]]
        }
        for (let i = 0; i < data8.length; i++) {
            if (data8[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data8[i].conjugated_forms[1][1] === verbSingleOne || data8[i].conjugated_forms[1][1] === verbSingleOne || data8[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data8[i]]
        }
        for (let i = 0; i < data9.length; i++) {
            if (data9[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data9[i].conjugated_forms[1][1] === verbSingleOne || data9[i].conjugated_forms[1][1] === verbSingleOne || data9[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data9[i]]
        }
        for (let i = 0; i < data10.length; i++) {
            if (data10[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data10[i].conjugated_forms[1][1] === verbSingleOne || data10[i].conjugated_forms[1][1] === verbSingleOne || data10[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data10[i]]
        }
        for (let i = 0; i < data11.length; i++) {
            if (data11[i].conjugated_forms[0][1].split(" ")[1] === verbSingleOne || data11[i].conjugated_forms[1][1] === verbSingleOne || data11[i].conjugated_forms[1][1] === verbSingleOne || data11[i].conjugated_forms[2][1] === verbSingleOne) result5 = [data11[i]]
        }
        return result5;
    }
    simo()
    console.log("voici la valeur du resultat5:", result5)

    if (result5 === undefined) result5 = seulverb;
    ...
    function seachVerb(e) {
        ...
        axios.get(`${cors}https://mesverbes.herokuapp.com/api/verbs`)
            .then(response => {
                const a = response.data
                const resu = a.map(element => element.verbe)
                let ssss = resu.filter(element => element.conjugated_forms[0][1].split(" ")[1] === inputValue || element.conjugated_forms[1][1] === inputValue || element.conjugated_forms[1][1] === inputValue || element.conjugated_forms[2][1] === inputValue)
                setresult2(ssss)
                console.log("asdfasdfasdfsadf", result2)
